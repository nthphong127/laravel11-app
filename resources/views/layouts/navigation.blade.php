        ...
        <div class="flex justify-between h-16">
            ...
            @auth
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <div class="border border-gray-500 rounded-lg flex items-center p-1">
                                ...
                                <button
                                    class=" inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium  text-black bg-white  focus:outline-none transition ease-in-out duration-150">
            ...
            @else
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    ...
                    <button class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded ms-2">
